...
答案：
1. B  
2. Thank you / Thanks very much / Thanks a lot  
...
### 1.*高义频：* **(用...) 进行交易；买卖 (货物)：**  
 ...
 > **trades with,in_1**  
 > England trades with nearly all the countries in different things in the world.   
...
### 4.*低义频：* **(异乎寻常或意外的) 转变；变化：**  
 ...
 > **took a turn for the better,worse_1**  
