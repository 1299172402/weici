...
it seems as if / though引导的从句中常使用虚拟语气。
...
在反意疑问句中，陈述部分含seldom时， 疑问部分用肯定形式。
     > You seldom go to the library, do you?   
     > 你很少去图书馆，是吗？

seldom置于句首表示强调时，句子常用部分倒装语序。
...
##### 题目  
We laugh at jokes, but seldom _________ about how they work.   
A.we think  
B.think we  
C.we do think  
D.do we think  
...
to choose sb / sth, usually carefully, from a number of similar things：
...
3. *高义频：* **[常用单数] 理解力；判断力**  
an ability to understand or judge sth：
...
4. *高义频：* **[U] 见识；通情达理**  
the knowledge of what’s sensible behavior; the ability to think or act in a reasonable or sensible way：
...
6. *高义频：* **[C] 意思；意义**  
the meaning of a word or phrase; a way of understanding sth：
...
二者均可表示“分开”。
2. *高义频：* **把...隔开**  
to lie or stand between two countries, areas, etc., keeping them apart：
...
3. *低义频：* **区分；分清：**  
to make sb / sth different in someway from sb / sth else：
...
---
##### 题目  
The little girl got _________ (分开) from the group in the dark.  
##### 答案 separated  
...
2. *高义频：* **重大的；重要的**  
important and needing to be thought about carefully：
...
2. *高义频：* **服务；效力；使用：**  
     ...
     > 1291年，在为皇帝效力了17年之后，马可·波罗回到了意大利。
...
---
1. *高义频：* **会议；一届会议；(法院) 开庭**  
a formal meeting or group of meetings, especially for a law court or parliament：
...
---
1. *低义频：* **坐下；(使) 处于舒适的位置**  
to get into or put sb into a comfortable position：
...
5. *低义频：* **(使) 平静；(使) 安定**  
to become or make sb / sth become calm or quiet：
...
to have or use sth with others：
...
to divide sth between two or more people：
     ...
     > 我尽自己的一点力来帮忙做家务，以分担妈妈的日常负担。

3. *高义频：* **vt & vi 共同具有**  
to have the same feelings, ideas, etc. as sb else：
...
to tell others about your ideas, experiences and feelings：
...
sudden and rapid, especially of a change：
...
2. *高义频：* **vi & vt 改变；更替**  
to change your opinion of or attitude towards sb / sth：
...
---
1. *高义频：* **重要的；重大的；显著的：**  
having an important effect or infl uence, especially on what will happen in the future：
...
2. *高义频：* **技能**  
an ability that you need to do a job, etc. well：
...
---
1. *高义频：* **略读；浏览**  
to read sth quickly to find the main points：
...
2. *低义频：* **略过；遗漏**  
to miss the next thing that you would normally read, do, etc.：
...
to not do sth that you usually do or should do (miss)：
...
so修饰置于单数可数名词之前的形容词时，语序为“so + adj + a / an + n”。
...
so意为“同样”、“也”时，常承接在肯定句后面，引起部分倒装。其结构为“so + 助动词 / 情态动词 / be动词 + 主语”。
...
“so + 主语 + 助动词 / 情态动词 / be动词”表示对之前或对方所说情况的赞同或证实，意为“对”或“的确如此”。
     > — It’s warmer today.  
     > 今天暖和一些了。
...
在so ... that 引导的复合句中，so位于句首时，主句部分要用倒装结构。
...
##### 题目  
So sudden _________ that the enemy had no time to escape.  
A.did the attack  
B.the attack did  
C.was the attack  
D.the attack was  
...
---
##### 题目  
The research lacks ________ evidence, and therefore, its conclusions are doubtful.  
A.solid  
B.fierce  
C.severe  
D.potential  
...
---
##### 题目  
Don’t worry if you can’t come to _________ party — I’ll save ________ cake for you.  
A.the; some  
B.a; much  
C.the; any  
D.a; little  
...
---
##### 题目  
There is ________ in his words. We should have a try.  
A.something  
B.anything  
C.nothing  
D.everything  
...
something, anything, nothing, somebody,anybody, nobody, everyone, anyone, no one等不定代词有修饰语修饰时，修饰语后置。
     > **something wrong**  
...
---
##### 题目  
No sooner ________ stepped on the stage than the audience broke into thunderous applause.  
A.had Mo Yan  
B.Mo Yan had  
C.has Mo Yan  
D.Mo Yan has  
...
---
1. *高义频：* **不用的；闲置的**  
not being used or not needed at the present：
...
3. *高义频：* **空闲的：**  
time when you are not working (free)：
...
---
1. *高义频：* **破坏；毁掉**  
to change sth good into sth bad, unpleasant, etc.; to ruin sth：
...
3. *高义频：* **时期；阶段**  
one part of the progress or development of sth：
...
---
1. *高义频：* **陈述；说明**  
to say or write sth, especially formally：
...
---
1. *高义频：* **状态；情况**  
the mental, emotional or physical condition that sb / sth is in：
...
1. *高义频：* **脚步；步：**  
     ...
     > 对于一个人来说，这只是一小步。但对人类来说，这却是巨大的一步。
...
---
1. *高义频：* **战略；策略**  
a plan that you use to achieve sth：
...
3. *高义频：* **实力**  
the power and influence that sb has：
...
4. *高义频：* **优点；长处**  
a good quality or ability that sb / sth has
反义词 weakness ： 
...
---
##### 题目  
One of the most effective ways to reduce _______ (压力) is to talk about feelings with someone you trust.
...
to come suddenly into sb’s mind：
...
4. *高义频：* **风度；气派**  
the ability to do things in a way that other people admire：
...
---
1. *高义频：* **成功；办成**  
to manage to achieve what you want：
...
such as常用来进行列举，并直接放在列举的名 词之前。for example表示“例如”，用来举例说明某一情况或论点，可放在句首、句中或句末。
...
---
##### 题目  
________ is the power of TV that it can make a person suddenly famous.  
A.Such  
B.This  
C.That  
D.So  
...
与不定冠词连用时，such要放在不定冠词之前；与no, all, many, one, few, several, some, any等连用时，则放在其后。
     > such a proposal   
     > 那样的建议
...
---
##### 题目  
The Great Wall is ________tourist attraction that millions of people pour in every year.  
A.so a well-known  
B.a so well-known  
C.such well-known a  
D.such a well-known  
...
##### 题目  
His plan was such a good one ________ we all agreed to accept it.   
##### 答案 that  
...
2. *高义频：* **受苦；感到疼痛；患病**  
to be badly affected by a disease, pain, a lack of sth, etc.：
...
2. *高义频：* **假定；假设**  
to pretend that sth will happen or is true：
...
—That’s _________sure. It’s too good an opportunity to miss.   
A.No problem!  
B.That’s for sure.  
C.Why me?  
D.Why bother?  
...
— _________. But I don’t know if he is in at the moment.   
A.Thanks   
B.Go on  
C.Sure   
D.You are welcome  
...
everything that is near or around you (environment)：
...
不能说He survived from / after / in the earthquake.
     > **survive on**  
...
2. *高义频：* **怀疑 (某人有罪)**  
to think that sb is probably guilty of a crime：
...
---
##### 题目  
It is important to have your eyes examined regularly to check for any sign of eye disease that may not have any _________.   
A.symptom   
B.similarity  
C.sample  
D.shadow  
