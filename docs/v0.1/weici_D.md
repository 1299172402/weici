...
---
1. *高义频：* **[U] 损害；损坏；损失**  
harm or injury caused when sth is broken or spoiled：


- #### do / cause damage to:

> The problem is clear: man has done great damage to his home over the years.  
> 问题显而易见：多年来，人类已经严重破坏了自己的家园。
...
---
1. *高义频：* **(正式的) 讨论；辩论**  
to discuss sth in a formal way or at a public meeting (discuss)：
...
2. *低义频：* **反复考虑；斟酌**  
to think about or discuss sth before deciding what to do：
...
---
##### 题目  
According to scientists, our mental abilities begin to ________ from the age of 27 after reaching the highest level at 22.   
A.differ   
B.shrink   
C.fail   
D.decline  
...
---
##### 题目  
Don’t defend him any more. It’s obvious that he ________  (故意地) destroyed the fence of the garden even without apology.   
A.accidentally  
B.carelessly  
C.deliberately  
D.clumsily  
...
2. *高义频：* **发表；表达；讲**  
to give a speech, talk, etc. or other official statement：
...
---
1. *高义频：* **(工作) 要求高的；费力的**  
needing a lot of effort, skill, care, etc.：
...
2. *高义频：* **(人) 要求严格的；苛求的**  
always wanting attention or expecting very high standards of people：
...
— Not really, but I can’t ________ (否认) that her remarks hurt me.   
A.deny  
B.refuse  
C.reject  
D.decline  
...
to plan or develop sth for a specific purpose： 
...
---
##### 题目  
It is unbelievable that Mr. Lucas leads a simple life ________ his great wealth.  
A.without  
B.despite  
C.in  
D.to  
...
---
1. *高义频：* **毁坏；摧毁；毁掉**  
to damage sth so badly that it can no longer be used or no longer exists：
...
> 我母亲认为那天很不错，但她还是有点失望，要是持续时间稍微再长点就好了。
...
2. *低义频：* **明显的；清楚的**  
easily or clearly seen, heard, smelled, etc.：
...
2. *高义频：* **使杰出；使显出特色**  
 to do sth which causes you to be noticed and admired：
...
---
##### 题目  
It doesn’t matter if they want to come to your party, ________?   
A.doesn’t it  
B.does it  
C.don’t they  
D.do they  
...
---
##### 题目  
That’s why I help brighten people’s days. If you _______, who’s to say that another person will?    
A.didn’t   
B.don’t  
C.weren’t  
D. haven’t  
...
在这个结构中，从属连词that引导同位语从 句，说明名词doubt的具体内容，that不可省略。
- #### doubt (as to):
...
> 如果我们有怀疑被告知的事情是否真实的习惯，我们就能找到正确的答案。
...
doubt后接宾语从句时，如果主句为疑问句或否定 句，连接词一般用that；如果主句为肯定句，连接词 一般用whether或if。
...
draw指用铅笔、钢笔、蜡笔等素描或绘画； paint指使用绘画颜料作画。
5. *低义频：* **吸引：**  
...
顺便走访某人为“drop in on sb”；顺便走访 某地为“drop in at some place”。
- #### drop off [非正式用语]
...
---
1. *高义频：* **预定的；预期的**  
arranged or expected to happen or arrive at a particular time：
...
3. *低义频：* **应得的；欠下的**  
owed to sb either as a debt or because they have done sth to deserve it：
